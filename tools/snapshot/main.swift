...
final class Shooter: NSObject, WKNavigationDelegate {
    ...
    init(markdown: String, out: URL, dark: Bool, size: NSSize) {
        self.out = out
    ...
    func webView(_ webView: WKWebView, didFinish nav: WKNavigation!) {
        // Give the web view a beat to lay out fonts before capturing.
...
let shooter = Shooter(markdown: text, out: URL(fileURLWithPath: args[2]), dark: dark,
